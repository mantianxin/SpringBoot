...
<div class="container" backgroundcolor="blue">
    ...
    <div class="col-md-4 column">
        ...
        <p>
            ...
            <a class="btn" href="${pageContext.request.contextPath}/Commoditylist/login">登录 »</a>
            <%--<a class="btn" href="${pageContext.request.contextPath}/Commoditylist/selectuser">测试页面test1 »</a>--%>
            <a class="btn" href="${pageContext.request.contextPath}/hutuzhang/login/loadbegin">一本糊涂账SSM版 »</a>
            <a class="btn" href="${pageContext.request.contextPath}/Commoditylist/registpage">注册用户</a>
            <a class="btn" href="${pageContext.request.contextPath}/Commoditylist/Echartsload">注册用户</a>
            <a class="btn" href="${pageContext.request.contextPath}/RecordList">分页展示消费信息</a>
        </p>
    </div>
</div>
</div>
