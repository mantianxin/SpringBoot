                ...
                <div class="col-xs-12">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="${pageContext.request.contextPath}/hutuzhang/hutubegin/Category/update" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="3">id</label>
                                        <input type="text" class="form-control" id="3" name ="id" placeholder="id">
                                    </div>
                                    <div class="form-group">
                                        <label for="1">分类</label>
                                        <input type="text" class="form-control" id="1" name ="name" placeholder="分类名">
                                    </div>
                                </div>
                                <!-- /.box-body -->
