            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    <%--账户页面url--%>
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>流水</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    <%--账户页面url--%>
                    <a href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/show/load">
                        <i class="fa fa-dashboard"></i> <span>图表</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <%--一览功能在add功能里实现--%>
                            <%--Record/recordlist?page=1&size=4   hutubegin/Record/recordlist?page=1&size=4--%>
                            <a  class="btn info" href="${pageContext.request.contextPath}/hutuzhang/hutubegin/orderlist/load">
                                消费一览
                            </a>
                            <a  class="btn btn-info" href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/addload">
                                记一笔（添加加查询）
                            </a>
                            <a  class="btn btn-danger" href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Category" >
                                消费分类
                            </a>
                                <%--柱状图实现功能--%>
                            <a class="btn btn-warning" href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/show/load">
                                月消费报表（柱状图）
                            </a>
                            <a class="btn btn-success"  href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Config">
                                设置（第一个开发）
                            </a>
                                <a class="btn btn-success"  href="${pageContext.request.contextPath}/hutuzhang/login/load">
                                   登录
                                </a>
                                <a class="btn btn-success"  href="${pageContext.request.contextPath}/hutuzhang/hutuzhangbegin/hutuecartstest">
                                    测试
                                </a>
