...
<body class="hold-transition skin-purple sidebar-mini">
			...
			<section class="content">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									<c:forEach items="${pageInfos.list}" var="record">
										<tr>
											<td><input name="ids" type="checkbox"></td>
											<td>${record.id}</td>
											<td>${record.spend}</td>
											<%-- 类名get显示 --%>
											<td>${record.cidname}</td>
											<%-- 日期get显示 --%>
											<td>${record.dateime}</td>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/recordlist?page=1&size=${pageInfos.size}" aria-label="Previous">首页</a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/recordlist?page=${pageInfos.pageNum-1}&size=${pageInfos.size}">上一页</a></li>
                            <c:forEach begin="1" end="${pageInfos.pages}" var="pageNum">
								<li><a href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/recordlist?page=${pageNum}&size=${pageInfos.size}">${pageNum}</a> </li>
							</c:forEach>
                            <li><a href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/recordlist?page=${pageInfos.pageNum+1}&size=${pageInfos.size}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/recordlist?page=${pageInfos.pageSize}&size=${pageInfos.size}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
	...
	<script>
		function changePageSize() {
			...
			//向服务器发送请求，改变没页显示条数
			location.href = "${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/recordlist?page=1&size=" + pageSize;
		}
