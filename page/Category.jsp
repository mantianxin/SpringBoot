...
<head>
    ...
    <title>一本糊涂账SSM版--消费分类参数页面</title>
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <!-- form start -->
                                ...
                                <a  class="btn btn-default" href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Category/add/load">
                                    新增
                                </a>
                                <a type="button" class="btn btn-info" href="">
                                    删除
                                </a>
                                <a type="button" class="btn btn-danger" href="${pageContext.request.contextPath}/hutuzhang/hutubegin/Category/update/load">
                                    修改
                                </a>
