                ...
                <div class="col-xs-12">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="${pageContext.request.contextPath}/hutuzhang//hutubegin/Config/add" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="3">id</label>
                                        <input type="text" class="form-control" id="3" name ="id" placeholder="具体金额">
                                    </div>
                                    <div class="form-group">
                                        <label for="1">预期花费</label>
                                        <input type="text" class="form-control" id="1" name ="key_" placeholder="具体金额">
                                    </div>
                                    <div class="form-group">
                                        <label for="2">数据库路径</label>
                                        <input type="text" class="form-control" id="2" name="value" placeholder="绝对路径">
                                    </div>
                                </div>
                                <!-- /.box-body -->
