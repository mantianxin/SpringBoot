...
<head>
    ...
    <title>一本糊涂账SSM版--消费记录添加页面</title>
                ...
                <div class="col-xs-12">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="${pageContext.request.contextPath}/hutuzhang/hutubegin/Record/load/add" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="1">id</label>
                                        <input type="text" class="form-control" id="1" name ="id" placeholder="id">
                                    </div>
                                    <div class="form-group">
                                        <label for="2">spend</label>
                                        <input type="text" class="form-control" id="2" name ="spend" placeholder="花费">
                                    </div>
                                    <div class="form-group">
                                        <label for="3">cid</label>
                                        <input type="text" class="form-control" id="3" name ="cid" placeholder="消费类别">
                                    </div>
                                    <div class="form-group">
                                        <label for="4">comment</label>
                                        <input type="text" class="form-control" id="4" name ="comment" placeholder="消费内容">
                                    </div>
                                    <div class="form-group">
                                        <label for="5">date</label>
                                        <input type="Date" class="form-control" id="5" name ="date" placeholder="消费时间">
