    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul id="wraps" class="nav navbar-nav">
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <ul id="wrap"class="dropdown-menu">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-default">
                        ...
                        <%--主题页面div区域--%>
                        <div class="box-body">
                            <span >净资产<p>0.00</p></span></hr>
                            <%--<span id="pay">本月收入0.00</span>--%>
                            <span CLASS="">资产<a>0.00</a><sapn class="pull-right">负债</sapn></span>
                            </br>
                            </br>
                            <hr/>
                            ...
                            <div class="pull-left">
                                <span class="pull-left">现金</span></br>
                            </div>
                            <div class="pull-right">
                                <span style="color: red" class="pull-right">0.00</span>
                            ...
                            <div class="pull-left">
                                <span class="pull-left">信用卡</span></br>
                            ...
                            <div class="pull-left">
                                <span class="pull-left">银行卡</span>

                            </div>
                            <div class="pull-right">
                                <span style="color: red" class="pull-right">0.00</span></br>
                            ...
                            <div class="pull-left">
                                <span class="pull-left">微信钱包</span></br>

                            </div>
                            <div class="pull-right">

                                <span class="pull-right" style="color: green">0.00</span></br>
                            </div>
                            </br>
                            </br>
                            </br>
                            ...
                            <div class="pull-left">
                                <span class="pull-left">支付宝</span></br>
    ...
    function ajaxname() {
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#wraps").append(' <li class="dropdown user user-menu">\n' +
                    '                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">\n' +
