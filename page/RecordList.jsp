                ...
                <div class="col-xs-12">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <a  class="btn btn-default" href="${pageContext.request.contextPath}/hutuzhang/hutubegin/">
                                新增
                            </a>
                            <a type="button" class="btn btn-info" href="">
                                删除
                            </a>
                            <a type="button" class="btn btn-danger" href="${pageContext.request.contextPath}/hutuzhang/hutubegin/">
                                修改
                            </a>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                <c:forEach items="${recordlist}" var="s" varStatus="vs">
                                    <tr>
                                        <td>${s.id}</td>
                                        <td>${s.cidname}</td>
                                        <td>${s.comment}</td>
