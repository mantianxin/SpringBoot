...
<div class="lo_main">
    ...
    <div class="lo_center">
        <form id="form" action="${pageContext.request.contextPath}/Commoditylist/loginpage" method="post">
            <table>
                <tr>
                    <td class="td_left">姓名</td>
                    <td class="td_right">
                        <input type="text" name="Uname" size="34px" id="user" onfocus="showTips('user','用户名必填！')" onblur="check('user','用户名不能为空！')" /><span id="userspan"></span>
                    </td>
                </tr>
                <tr>
                    <td class="td_left">密码</td>
                    <td class="td_right">
                        <input type="password" name="Upassword" size="34px" id="password" onfocus="showTips('password','密码必填')" onblur="check('password','密码不能为空!')" /><span id="passwordspan"></span>
                    </td>
                </tr>
                <%--<tr>--%>
                ...
                <tr>
                    <td class="td_left"></td>
                    <td class="td_right"><input type="submit" id="bt_sub" value="登录">
                    </td>
                </tr>
            </table>
        </form>
